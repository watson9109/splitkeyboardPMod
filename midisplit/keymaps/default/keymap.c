...
#define LT_SYM  LT(_NUMBER, KC_LANG5)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_ABC] = LAYOUT(  // ABC
        ...
        KC_NO,              KC_NO,          KC_NO,          KC_NO,              KC_H,           KC_J,           KC_K,           KC_L,           KC_LEFT_BRACKET,KC_ENT,
    ...
    [_NUMBER] = LAYOUT(   // MIDI
        KC_ESC,             _______,        KC_KP_7,        KC_KP_8,            KC_KP_9,        KC_T,           KC_NO,          KC_NO,          KC_NO,          KC_NO,        
        KC_LCTL,             KC_KP_0,        KC_KP_4,        KC_KP_5,            KC_KP_6,        KC_G,          KC_NO,          KC_NO,          KC_NO,          KC_NO,   
        KC_LSFT,             _______,        KC_KP_1,        KC_KP_2,            KC_KP_3,        KC_B,          KC_NO,          KC_NO,          KC_NO,          KC_NO,   
        KC_NO,              KC_NO,          KC_NO,          KC_NO,              KC_NO,          KC_NO,          KC_BACKSPACE,   KC_TAB,         KC_LEFT_SHIFT,  KC_LEFT_CTRL, 
        KC_NO,              KC_NO,          KC_NO,          KC_NO,              KC_F9,          KC_F10,         KC_F11,         KC_F12,         KC_PSCR,           KC_LEFT_SHIFT,   
        KC_NO,              KC_NO,          KC_NO,          KC_NO,              KC_F5,          KC_F6,          KC_F7,          KC_F8,          KC_LEFT_BRACKET,KC_RIGHT_BRACKET,
        KC_NO,              KC_NO,          KC_NO,          KC_NO,              KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_SLASH,       KC_BACKSLASH, 
        MS_BTN1,            MS_BTN2,        KC_ENTER,       KC_BACKSPACE,       KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO          
    ),
    [_SYMBOL] = LAYOUT(  // NUMBER
        KC_ESC,            KC_0,           KC_1,           KC_2,               KC_3,           KC_4,           KC_NO,          KC_NO,          KC_NO,          KC_NO,        
        KC_LCTL,             KC_A,           KC_S,           KC_D,               KC_F,           KC_G,           KC_NO,          KC_NO,          KC_NO,          KC_NO,   
        KC_LSFT,             KC_Z,           KC_X,           KC_C,               KC_V,           KC_B,           KC_NO,          KC_NO,          KC_NO,          KC_NO,   
        KC_NO,              KC_NO,          KC_NO,          KC_NO,              KC_NO,          KC_NO,          KC_BACKSPACE,   KC_TAB,         KC_LEFT_SHIFT,  KC_LEFT_CTRL, 
        KC_NO,              KC_NO,          KC_NO,          KC_NO,              KC_5,           KC_6,           KC_7,           KC_8,           KC_9,           KC_LEFT_SHIFT,   
    ...
    [_MIDI] = LAYOUT(  // SYMBOL
        TG_MIDI,            KC_Q,           KC_W,           KC_E,               KC_R,           KC_T,           KC_NO,          KC_NO,          KC_NO,          KC_NO,        
        TG_NUM,             KC_A,           KC_S,           KC_D,               KC_F,           KC_G,           KC_NO,          KC_NO,          KC_NO,          KC_NO,   
        TG_ABC,             KC_Z,           KC_X,           KC_C,               KC_V,           KC_B,           KC_NO,          KC_NO,          KC_NO,          KC_NO,   
        KC_NO,              KC_NO,          KC_NO,          KC_NO,              KC_NO,          KC_NO,          KC_BACKSPACE,   KC_TAB,         KC_LEFT_SHIFT,  KC_LEFT_CTRL, 
